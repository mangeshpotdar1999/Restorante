...
class Contact extends Component {
    ...
    //         errors.telnum = 'Telnum should contain only number';
        ...
        return(
            <div className="container">
                ...
                <div className="row row-header">
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1 mt-2 mb-2">
                ...
                <div className="row row-content">
                    ...
                    <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className="form-group">
                                <Label htmlFor="telnum" md={2}>ContactTel</Label>
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum" placeholder="contactTel." 
                                    className="form-control"
                                    validators={{
                                    ...
                                    onBlur={this.handleOnBlur('telnum')}
                                    onChange={this.handleInpuChange}/>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" id="message" name="message" placeholder="Your Feedback" row="12" className="form-control" />
                                </Col>
                            </Row>
                            {/* <FormGroup row>
                                <Label htmlFor="phone" md={2}>Phone</Label>
                                <Col md={10}>
                                    <Input type="phone" id="phone" name="phone" placeholder="Phone" value={this.state.phone}/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                                <Label htmlFor="address" md={2}>Address</Label>
                                <Col md={10}>
                                    <Input type="text" id="address" name="address" placeholder="Address" value={this.state.check}/>
                                </Col>
                            </FormGroup> */}
                            <Row className="form-group">
